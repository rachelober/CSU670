...
class Battle  
    ...
    until (battle_over?)
      ...
      thread = Thread.new do
        begin
          ...
          kick_player(player, playerstate, "TIMING VIOLATION")
          Thread.kill(self)
  ...
  def update_score
    ...
    @playerstates.each{|playerstate|
      playerstate.score = playerstate.score - playerstate.hand.value}
    nil
  end
  ...
  def update_battle(return_card, turn_discards, turn_attacks, from_where, player, playerstate)
    ...
    playerstate.hand = update_playerstate(playerstate, turn_discards, turn_attacks, return_card)
  ...
  def update_playerstate(playerstate, turn_discards, turn_attacks, return_card)
    ...
    playerstate.hand.minus(played_cards)
  end
