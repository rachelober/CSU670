...
class TestSquadron < Test::Unit::TestCase
  ...
  def test_xml_to_squadron
    ...
    assert_equal(Squadron.new([@air4, @air5, @air6]), Squadron.xml_to_squad(squad_test))
  end
  ...
  def test_squadron_to_xml
    ...
    assert_equal(ex_norm, norm.squadron_to_xml)
    assert_equal(ex_empty, empty.squadron_to_xml)
  end
end
