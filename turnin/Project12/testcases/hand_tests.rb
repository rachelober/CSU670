...
class TestHand < Test::Unit::TestCase
  ...
  def test_minus
    ...
    minus_test_delete_hand1 = [@air1, @air4, @air5, @keep1]
    ...
    minus_test_hand1 = Hand.new([@air2, @air3, @air6])
  ...
  def test_xml_to_fsth
    ...
    assert_same(expected_fsth, Hand.xml_to_fsth(fsth_doc))
  end
end
