...
class TestPlayer < Test::Unit::TestCase
    ...
    def test_make_max_attacks_no_wildcards
        player2 = Player.new("Player 2", false)
        ...
        result = player2.make_max_attacks(list_of_allies, list_of_axis)

        assert_instance_of(Array, result, "Player.make_max_attacks failed")
        assert_equal(expected_attack_list, result, "Player.make_max_attacks failed")
    end


    def test_make_max_attacks_one_wildcard
        player2 = Player.new("Player 2", false)
    ...
    def test_make_max_attacks_two_wildcards
        ...
        result = player2.make_max_attacks(list_of_allies, list_of_axis)
        assert_instance_of(Array, result, "Player.make_max_attacks failed")
        assert_equal([], result, "Player.make_max_attacks failed")
    end

    def test_make_max_discards_no_wildcards
        player2 = Player.new("Player 2", false)
        ...
        assert_instance_of(Array, player2.make_max_discards, "Player.make_max_discards failed")
        assert_equal(expected_squad_list, player2.make_max_discards, "Player.make_max_discards failed")
    end

    def test_make_max_discards_one_wildcard
        player2 = Player.new("Player 2", false)
    ...
    def test_make_max_discards_two_wildcards
        player2 = Player.new("Player 2", false)
        player2.player_first_hand([@air1, @keep1, @vic1, @air2, @air3, @air4])
    ...
    def test_player_take_turn_end_nil
        player2 = Player.new("Player 2", false)
        player2.player_first_hand([@air1, @air2, @air3, @air4, @air5])
    ...
    def test_player_take_turn_end_card
        ...
        list_of_discards = [Squadron.new([@air1, @air2, @air3]), Squadron.new([@air10, @air11, @air12])]
