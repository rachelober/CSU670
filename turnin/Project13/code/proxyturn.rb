...
class ProxyTurn < Turn  
  ...
  def initialize(is_card_on_deck, stack, list_of_squadrons, socket)
  ...
  # ProxyTurn.xml_to_proxyturn : Document Socket -> ProxyTurn
  #
  # Converts the XML into a ProxyTurn.
  def ProxyTurn.xml_to_proxyturn(doc, socket)
    ...
    ProxyTurn.new(bool, stck, slist, socket)
  end
end
