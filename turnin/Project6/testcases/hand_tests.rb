...
class TestHand < Test::Unit::TestCase
	...
	def setup
		...
		@air7 = Aircraft.new(image, "Dornier Do 26", axis, bomber, 2)
    ...
    def test_hand_to_list
        ...
        expected_hand1 = [@air1, @air2, @air3, @air4, @air5, @air6, @keep1]
		expected_hand2 = [@keep1, @keep2, @keep3, @keep4, @keep5, @vic1, @keep6]
		expected_hand3 = [@air1, @air2, @air3, @air4, @air5, @air6, @air7]
		expected_hand4 = [@vic1]
		expected_hand5 = [@air1, @keep2, @keep3, @keep4, @keep5, @vic1, @keep6]
    ...
    def test_completes
		...
		assert(Squadron.same_squad_list?(complete_test_hand1, @hand1.completes), "Hand.completes failed")
        
        assert_instance_of(Array, @hand2.completes, "Hand.completes failed")
		assert(Squadron.same_squad_list?(complete_test_hand2, @hand2.completes), "Hand.completes failed")
        
        assert_instance_of(Array, @hand3.completes, "Hand.completes failed")
		assert(Squadron.same_squad_list?(complete_test_hand3, @hand3.completes), "Hand.completes failed")
        
        assert_instance_of(Array, @hand4.completes, "Hand.completes failed")
		assert(Squadron.same_squad_list?(complete_test_hand4, @hand4.completes), "Hand.completes failed")
        
        assert_instance_of(Array, @hand5.completes, "Hand.completes failed")
		assert(Squadron.same_squad_list?(complete_test_hand5, @hand5.completes), "Hand.completes failed")
    end

    def test_wildcards
		#Expected result of Hand.wildcard test
		wildcards_test_hand1 = [@keep1]
        wildcards_test_hand2 = [@keep1, @keep2, @keep3, @keep4, @keep5, @vic1, @keep6]
        wildcards_test_hand3 = []
        wildcards_test_hand4 = [@vic1]
        wildcards_test_hand5 = [@keep2, @keep3, @keep4, @keep5, @vic1, @keep6]
    ...
    def test_complementable
        complement_test_hand1 = [Squadron.new([@air4, @air5, @keep1])]
        complement_test_hand2 = []
        complement_test_hand3 = []
        complement_test_hand4 = []
        complement_test_hand5 = [Squadron.new([@air1, @keep2, @keep3])]
		
        assert_instance_of(Array, @hand1.complementable, "Hand.complementable failed")
        assert(Squadron.same_squad_list?(complement_test_hand1, @hand1.complementable), "Hand.complementable failed")

        assert_instance_of(Array, @hand2.complementable, "Hand.complementable failed")
		assert(Squadron.same_squad_list?(complement_test_hand2, @hand2.complementable), "Hand.complementable failed")
        
        assert_instance_of(Array, @hand3.complementable, "Hand.complementable failed")
		assert(Squadron.same_squad_list?(complement_test_hand3, @hand3.complementable), "Hand.complementable failed")
		
        assert_instance_of(Array, @hand4.complementable, "Hand.complementable failed")
		assert(Squadron.same_squad_list?(complement_test_hand4, @hand4.complementable), "Hand.complementable failed")
		
        assert_instance_of(Array, @hand5.complementable, "Hand.complementable failed")
		assert(Squadron.same_squad_list?(complement_test_hand5, @hand5.complementable), "Hand.complementable failed")
    end
