...
class Player
  ...
  # inform : Player Squadron -> Boolean?
  #
  # Informs the Player that a Bomber Squadron was shot down.
  def inform(squadron)
    @discards = @discards - [squadron]
    self.notify
    true
  end
  ...
  # tend : String -> nil
  #
  # Notified that it is the end of the Game.
  def tend(mesg)
  end
end
